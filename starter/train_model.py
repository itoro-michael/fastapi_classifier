...
def main():
    ...
    logging.info(f'Running the create_metric_data function.')
...
def save_metric_data(list_metric_data:list, file_path:str):
    ...
    with open(file_path, "wt") as fp:
        ...
        writer.writerow(['column_name', 'column_value', 'precision', 'recall', 'fbeta'])
...
def create_metric_data( input_df:pd.DataFrame, 
    ...
    for column_value in list_column_value:
        precision, recall, fbeta = compute_model_metrics_on_column_value(input_df, 
                                            column_name,
                                            column_value,
                                            ...
                                            lb,
                                            model)
        list_output.append([column_name, column_value, precision, recall, fbeta])
        print([column_name, column_value, precision, recall, fbeta])
    return list_output
...
def compute_model_metrics_on_column_value(  input_df:pd.DataFrame, 
    ...
    """
    df = dataset_with_selected_column_value(input_df, column_name, column_value)
